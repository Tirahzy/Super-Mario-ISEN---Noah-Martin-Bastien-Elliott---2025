...
static char niveau1[MAP_HAUTEUR][MAP_LARGEUR] = {
    "********************************************************************************************************",
    "*                                                                                                      *",
    "*     $$$                                                                                              *",
    "*    #####                                                                                              *",
...
static char niveau3[MAP_HAUTEUR][MAP_LARGEUR] = {
    "********************************************************************************************************",
    "*                                                                                                      *",
    "*     $3                                                                                             *",
    "*    #3                                                                                              *",
...
static char niveau4[MAP_HAUTEUR][MAP_LARGEUR] = {
    "********************************************************************************************************",
    "*                                                                                                      *",
    "*     $4                                                                                             *",
    "*    #4                                                                                              *",
...
static char niveau5[MAP_HAUTEUR][MAP_LARGEUR] = {
    "********************************************************************************************************",
    "*                                                                                                      *",
    "*     $5                                                                                             *",
    "*    #5                                                                                              *",
...
static char niveau6[MAP_HAUTEUR][MAP_LARGEUR] = {
    "********************************************************************************************************",
    "*                                                                                                      *",
    "*     $6                                                                                             *",
    "*    #6                                                                                              *",
...
static char niveau7[MAP_HAUTEUR][MAP_LARGEUR] = {
    "********************************************************************************************************",
    "*                                                                                                      *",
    "*     $7                                                                                             *",
    "*    #7                                                                                              *",
...
static char niveau8[MAP_HAUTEUR][MAP_LARGEUR] = {
    "********************************************************************************************************",
    "*                                                                                                      *",
    "*     $8                                                                                             *",
    "*    #8                                                                                              *",
...
static char niveau2[MAP_HAUTEUR][MAP_LARGEUR] = {
    "********************************************************************************************************",
    "*                                                                                                      *",
    "*                         $$$$$$                                                                       *",
    "*                        #######                                                                       *",
